...
public class NotificationController implements NotificationApi {
    ...
    @Override
    @Permit(permitAll = false, description = "SSE 알림 구독")
    public SseEmitter subscribe(User user) {
        return notificationService.subscribe(user.getId());
    }

    @Override
    @Permit(permitAll = false, description = "알림 목록 조회")
    ...
    @Override
    @Permit(permitAll = false, description = "읽지 않은 알림 수 조회")
    ...
    @Override
    @Permit(permitAll = false, description = "알림 읽음 처리")
    ...
    @Override
    @Permit(permitAll = false, description = "알림 삭제")
    ...
    @Override
    @Permit(permitAll = false, description = "모든 알림 읽음 처리")
    ...
    @Override
    @Permit(permitAll = false, description = "모든 알림 삭제")
