...
public interface AdminPolicyApi {
    ...
    @Operation(
        summary = "정책 목록 조회",
        description = "시스템에 등록된 모든 정책을 조회합니다."
    )
    ...
    ResponseEntity<PolicyDetailResponse> getPolicy(
    ...
    @Operation(
        summary = "정책에 권한(Permission) 할당",
        description = "특정 정책에 권한을 할당합니다."
    )
    ...
    @Operation(
        summary = "정책에서 권한(Permission) 제거",
        description = "특정 정책에서 권한 할당을 해제합니다."
    )
