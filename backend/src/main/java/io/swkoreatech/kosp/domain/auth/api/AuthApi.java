...
public interface AuthApi {
    ...
    @Operation(
        summary = "1. Github 토큰 교환 (회원가입용)",
        description = "Github Access Token을 검증하고 회원가입용 토큰(JWS)을 발급합니다."
    )
    ...
    @Operation(
        summary = "2. 학번/사번 중복 확인",
        description = "회원가입 시 학번 또는 사번의 중복 여부와 형식을 확인합니다. (학번: 10자리, 사번: 6/8자리)"
    )
    ...
    @Operation(
        summary = "3. 이메일 인증 코드 발송",
        description = "회원가입을 위해 이메일로 인증 코드를 발송합니다."
    )
    ...
    @Operation(
        summary = "5. 회원가입 토큰 검증",
        description = "회원가입 폼 진입 전 JWS 토큰의 유효성을 검증합니다. 위변조된 토큰은 접근을 차단합니다."
    )
    ...
    @Operation(
        summary = "7. Github 로그인",
        description = "Github Access Token을 사용하여 로그인하고 Access Token과 Refresh Token을 발급합니다."
    )
    ...
    @Operation(
        summary = "10. 로그인 토큰 검증",
        description = "Access Token의 유효성을 검증합니다. 만료되거나 위변조된 토큰은 차단합니다."
    )
    ...
    @Operation(
        summary = "11. 비밀번호 재설정 메일 발송",
        description = "비밀번호 재설정을 위해 이메일로 링크를 발송합니다."
    )
    ...
    @Operation(
        summary = "12. 비밀번호 재설정",
        description = "발송된 링크의 토큰을 사용하여 비밀번호를 재설정합니다."
    )
