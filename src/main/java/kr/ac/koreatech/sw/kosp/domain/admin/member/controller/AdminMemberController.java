...
public class AdminMemberController implements AdminMemberApi {
    ...
    public ResponseEntity<kr.ac.koreatech.sw.kosp.domain.admin.member.dto.response.AdminUserListResponse> getUsers(int page, int size) {
        org.springframework.data.domain.Pageable pageable = org.springframework.data.domain.PageRequest.of(page, size);
        kr.ac.koreatech.sw.kosp.domain.admin.member.dto.response.AdminUserListResponse response = adminMemberService.getUsers(pageable);
